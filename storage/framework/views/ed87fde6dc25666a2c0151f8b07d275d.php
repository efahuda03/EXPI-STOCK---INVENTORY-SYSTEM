        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-end mb-3">
                    <a href="<?php echo e(route('batch.create')); ?>" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive-md mt-3">
                            <table class="table table-hover align-middle" id="table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $listBatch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center justify-content-center">
                                                <a href="<?php echo e(route('batch.edit', $batch->uuid)); ?>" 
                                                ...
                                                <button type="button" 
                                                        ...
                                                        data-bs-target="#modalDelete<?php echo e($batch->id); ?>">
                                                    <i class="ti ti-trash"></i>
                                                </button>
                                            </div>

                                            <div class="modal fade" id="modalDelete<?php echo e($batch->id); ?>" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-center py-4">
                                                            ...
                                                            <h4 class="mt-2"><?php echo e($batch->batch_number); ?></h4>
                                                            <p class="small text-muted">Product: <?php echo e($batch->product->name ?? 'N/A'); ?></p>
                                                            <small class="text-danger">Warning: This will affect your stock count.</small>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                            <form action="<?php echo e(route('batch.destroy', $batch->uuid)); ?>" method="POST">
                                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\cartoonnurefahud3\OneDrive\Desktop\expi-stock\resources\views/batch/index.blade.php ENDPATH**/ ?>