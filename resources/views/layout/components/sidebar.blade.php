        ...
        <div class="brand-logo d-flex align-items-center justify-content-between">
            <a href="./index.html" class="text-nowrap logo-img">
                <div class="d-flex align-items-center">
                    <img src="{{ asset('assets/img/logo.jpeg') }}" class="me-2 rounded" width="45" height="40" />
                    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    ...
                    href="{{ route('batch.index') }}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    ...
                    href="{{ route('notification.index') }}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    ...
                    href="{{ route('audit_log.index') }}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    ...
                    href="{{ route('access_code.index') }}" aria-expanded="false">
                        <i class="ti ti-lock"></i>
                ...
                <li class="sidebar-item">
                    ...
                    href="{{ route('alert_configuration.index') }}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    ...
                    href="{{ route('expiry_status.index') }}" aria-expanded="false">
