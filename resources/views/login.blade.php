        ...
        <div class="card-body">
            <a href="javascript:void(0)" class="text-nowrap logo-img text-center d-block mb-4 w-100">
                <div class="d-flex align-items-center justify-content-center mb-4">
                    <img src="{{ asset('assets/img/logo.jpeg') }}" height="80" width="100" class="me-3 rounded">
                </div>
            ...
            <form action="{{ route('login.check') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <a href="{{ route('forgot_password') }}" class="text-primary fw-bold"><small>Forgot Password?</small></a>
                </div>
