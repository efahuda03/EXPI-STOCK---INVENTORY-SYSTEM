        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-end mb-3">
                    <a href="{{ route('alert_configuration.create') }}" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive-md mt-3">
                            <table class="table table-hover align-middle" id="table">
                                ...
                                <tbody>
                                    @foreach ($listAlert30Days as $index => $alert)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        ...
                                        <td  class="text-center">
                                            <button type="button" 
                                                    ...
                                                    data-bs-target="#modalDelete{{ $alert->id }}">
                                                <i class="ti ti-trash"></i>
                                            </button>
                                            <div class="modal fade" id="modalDelete{{ $alert->id }}" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{ route('alert_configuration.destroy', $alert->uuid) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive-md mt-3">
                            <table class="table datatable table-hover align-middle">
                                ...
                                <tbody>
                                    @foreach ($listAlert7Days as $index => $alert)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $alert->user->name ?? '-' }}</td>
                                        <td>{{ $alert->user->email ?? '-' }}</td>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive-md mt-3">
                            <table class="table datatable table-hover align-middle">
                                ...
                                <tbody>
                                    @foreach ($listAlert3Days as $index => $alert)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $alert->user->name ?? '-' }}</td>
                                        <td>{{ $alert->user->email ?? '-' }}</td>
